...
Copied from https://github.com/haosulab/ManiSkill/pull/1171/files#diff-0940d313d9b7a5e597bee26c686d39ac88902a68cbf1f1e4f5a0aca380262c07L16
"""
...
class LeRobotRealAgent(BaseRealAgent):
    ...
    def __init__(self, robot: Robot, use_cached_qpos: bool = True, **kwargs):
        ...
        if (
            self.real_robot.name == "so100_follower"
            or self.real_robot.name == "so101_follower"
        ):
