...
def main(args: Args):
    ...
    real_env = Sim2RealEnv(sim_env=sim_env, agent=real_agent, real_reset_function=real_reset_function)
    real_obs, _ = real_env.reset()
    print("Check the real robot lines up with the guide picture here: https://github.com/StoneT2000/lerobot-sim2real/blob/main/docs/assets/calibration_guide.png. If not, tune the calibration offset and try again.")
